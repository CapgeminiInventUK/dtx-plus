...
function fixColumnWidths() {
    ...
    const tableColumnWidths = <string[]>[];
    const tableWidthElems = document
        .querySelectorAll<HTMLTableColElement>("#G_uwgItems colgroup col");
    ...
    const tableHeaderCells = document
        .querySelectorAll<HTMLElement>("#uwgItems_hdiv table thead tr th");
